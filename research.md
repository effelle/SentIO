...
Adding an SD Card ComponentBecause ESPHome does not have built-in support for SD card reading/writing, you will use community-developed external components. The most popular and well-maintained external repositories are the [n-serrette SD Card Component](https://github.com/n-serrette/esphome_sd_card) or [Mnark's ESPHome Components](https://github.com/Mnark/esphome-components).